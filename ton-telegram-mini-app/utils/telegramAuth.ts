...
export function validateTelgramWebAppData(telegramInitData: string): ValidationResult {
    ...
    const calculateHash = crypto.createHmac('sha256', secretKey ).update(dataCheckString).digest('hex')
